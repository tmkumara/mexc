...
MAX_OB_DISTANCE_ATR: float = float(getattr(_cfg, "MAX_OB_DISTANCE_ATR", 2.0))
MAX_OB_DISTANCE_PCT: float = float(getattr(_cfg, "MAX_OB_DISTANCE_PCT", 1.20))
EXPIRE_IF_PRICE_AWAY_ATR: float = float(getattr(_cfg, "EXPIRE_IF_PRICE_AWAY_ATR", 3.0))
EXPIRE_IF_PRICE_AWAY_PCT: float = float(getattr(_cfg, "EXPIRE_IF_PRICE_AWAY_PCT", 2.0))
...
MSS_BREAK_LOOKBACK_CANDLES: int = int(getattr(_cfg, "MSS_BREAK_LOOKBACK_CANDLES", 2))
